...
class AIManager {
    ...
    static PERSONA_PROMPTS = {
        encouraging:
            'You are Kanji Sensei, a warm, highly encouraging, and empathetic Japanese language teacher. You praise student progress and explain kanji concepts in simple, intuitive, and delightful ways. Use warm and supportive language.',
        strict: 'You are Master Kenji, a disciplined and razor-sharp traditional Japanese calligraphy master. You deliver concise, pinpoint-accurate critiques, identify precise error patterns, and provide exacting guidance for perfect execution.',
        mnemonic:
            'You are the Memory Magician, an expert in vivid visual mnemonics and radical etymology. You break down complex kanji into striking, hilarious, or unforgettable mental movies so students remember them forever.',
        anime: 'You are your cheerful anime senpai study partner! You use energetic and friendly language, peppered with natural Japanese conversational encouragement like よし！, 頑張ってね！, and occasional romaji explanations when helpful.'
    };
...
${kanjiData.strokes && kanjiData.strokes > 12 ? `5. **Stroke Warning**: This complex kanji has ${kanjiData.strokes} strokes. Point out the trickiest stroke transitions and commonly confused stroke sequences.` : ''}${jlptContext}`;
    ...
    static async askSenseiQuestion(question, currentKanji = null) {
        ...
        if (currentKanji) {
            prompt += `\n\nCurrently viewing Kanji card: ${currentKanji.character} (Meanings: ${(currentKanji.meanings || []).join(', ')}, Readings: ${[
                ...(currentKanji.onyomi || []),
